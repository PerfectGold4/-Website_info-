$(function(){
	 ...
	 $('.base')
	 	.click(function() { location.href = 'main/base.html'});
	 $('.more')
	 	.click(function() { location.href = 'main/more.html'});
	 $('.cov')
	 	.click(function() { location.href = 'main/cover.html'});
	 $('.ex')
	 	.click(function() { location.href = 'main/ex.html'});
